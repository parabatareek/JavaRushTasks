...
public class NimrodAi {
    ...
    public static void main(String[] args) {
        ...
        String[] rooms = new String[]{"diningRoom", "o2", "medRoom", "armoury", "securityRoom", "reactor", "telecom", "warehouse", "controlRoom", "powerRoom"};
        for (String room :
                rooms) {
            if (checkPirates(room)) openFloodgates(room);
        }
    }
